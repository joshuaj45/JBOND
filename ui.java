...
public class ui extends JFrame {
	...
	public ui() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		JButton btnCg = new JButton("Sg");
		btnCg.setToolTipText("<html>Seaborgium<br>Atomic #: 106</html>");
		btnCg.setBounds(300, 426, 58, 58);
		contentPane.add(btnCg);
		...
		JButton btnHt = new JButton("Hs");
		btnHt.setToolTipText("<html>Hassium<br>Atomic #: 108</html>");
		btnHt.setBounds(416, 426, 58, 58);
		contentPane.add(btnHt);
		...
		JButton btnTn = new JButton("Ts");
		btnTn.setToolTipText("<html>Tennessine<br>Atomic #: 117</html>");
		btnTn.setBounds(938, 426, 58, 58);
		contentPane.add(btnTn);
		...
		JButton btnOm = new JButton("Os");
		btnOm.setToolTipText("<html>Osmium<br>Atomic #: 76</html>");
		btnOm.setBounds(416, 368, 58, 58);
		contentPane.add(btnOm);
		...
		JButton btnPl = new JButton("Pt");
		btnPl.setToolTipText("<html>Platinum<br>Atomic #: 78</html>");
		btnPl.setBounds(532, 368, 58, 58);
		contentPane.add(btnPl);
		...
		JButton btnPa = new JButton("Pd");
		btnPa.setToolTipText("<html>Paladium<br>Atomic #: 46</html>");
		btnPa.setBounds(532, 310, 58, 58);
		...
		JButton btnTh_1 = new JButton("Tl");
		btnTh_1.setToolTipText("<html>Thallium<br>Atomic #: 81</html>");
		btnTh_1.setBounds(706, 368, 58, 58);
		contentPane.add(btnTh_1);
		...
		JButton btnRh_1 = new JButton("Re");
		btnRh_1.setToolTipText("<html>Rhenium<br>Atomic #: 75</html>");
		btnRh_1.setBounds(358, 368, 58, 58);
		contentPane.add(btnRh_1);
		...
		JButton btnTh_2 = new JButton("Th");
		btnTh_2.setToolTipText("<html>Thorium<br>Atomic #: 90</html>");
		btnTh_2.setBounds(242, 568, 58, 58);
		contentPane.add(btnTh_2);
		...
		JButton btnPa_1 = new JButton("Pa");
		btnPa_1.setToolTipText("<html>Protactinium<br>Atomic #: 91</html>");
		btnPa_1.setBounds(300, 568, 58, 58);
		contentPane.add(btnPa_1);
		
		JButton btnNe_1 = new JButton("Nd");
		btnNe_1.setToolTipText("<html>Neodymium<br>Atomic #: 60</html>");
		btnNe_1.setBounds(358, 510, 58, 58);
		contentPane.add(btnNe_1);
		...
		JButton btnTh = new JButton("Tm");
		btnTh.setToolTipText("<html>Thulium<br>Atomic #: 69</html>");
		btnTh.setBounds(880, 510, 58, 58);
		...
		JButton btnLt = new JButton("Lu");
		btnLt.setToolTipText("<html>Lutetium<br>Atomic #: 71</html>");
		btnLt.setBounds(996, 510, 58, 58);
		...
		JButton btnCs_1 = new JButton("Cf");
		btnCs_1.setToolTipText("<html>Califormium<br>Atomic #: 98</html>");
		btnCs_1.setBounds(706, 568, 58, 58);
