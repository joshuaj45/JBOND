...
public class ui extends JFrame {
	...
	public ui() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		btnNewButton.setToolTipText("<html>Hydrogen<br>Atomic #: 1<br>Electronegativity Value: 2.20</html>");
		btnNewButton.setBounds(10, 78, 58, 58);
		contentPane.add(btnNewButton);
		
		JButton btnLi = new JButton("Li");
		btnLi.setToolTipText("<html>Lithium<br>Atomic #: 3<br>Electronegativity Value: 0.98</html>");
		btnLi.setBounds(10, 136, 58, 58);
		contentPane.add(btnLi);
		
		JButton btnNa = new JButton("Na");
		btnNa.setToolTipText("<html>Sodium<br>Atomic #: 11<br>Electronegativity Value: 0.93</html>");
		btnNa.setBounds(10, 194, 58, 58);
		contentPane.add(btnNa);
		
		JButton btnK = new JButton("K");
		btnK.setToolTipText("<html>Potassium<br>Atomic #: 19<br>Electronegativity Value: 0.82</html>");
		btnK.setBounds(10, 252, 58, 58);
		contentPane.add(btnK);
		
		JButton btnRb = new JButton("Rb");
		btnRb.setToolTipText("<html>Rubidium<br>Atomic #: 37<br>Electronegativity Value: 0.82</html>");
		btnRb.setBounds(10, 310, 58, 58);
		contentPane.add(btnRb);
		
		JButton btnCs = new JButton("Cs");
		btnCs.setToolTipText("<html>Cesium<br>Atomic #: 55<br>Electronegativity Value: 0.79</html>");
		btnCs.setBounds(10, 368, 58, 58);
		contentPane.add(btnCs);
		
		JButton btnFr = new JButton("Fr");
		btnFr.setToolTipText("<html>Francium<br>Atomic #: 87<br>Electronegativity Value: 0.70</html>");
		btnFr.setBounds(10, 426, 58, 58);
		contentPane.add(btnFr);
		
		JButton btnBe = new JButton("Be");
		btnBe.setToolTipText("<html>Beryllium<br>Atomic #: 4<br>Electronegativity Value: 1.57</html>");
		btnBe.setBounds(68, 136, 58, 58);
		contentPane.add(btnBe);
		
		JButton btnRa = new JButton("Ra");
		btnRa.setToolTipText("<html>Radium<br>Atomic #: 88<br>Electronegativity Value: 0.89</html>");
		btnRa.setBounds(68, 426, 58, 58);
		contentPane.add(btnRa);
		
		JButton btnRf = new JButton("Rf");
		btnRf.setToolTipText("<html>Rutherfordium<br>Atomic #: 104<br>Electronegativity Value: Unknown</html>");
		btnRf.setBounds(184, 426, 58, 58);
		contentPane.add(btnRf);
		
		JButton btnDb = new JButton("Db");
		btnDb.setToolTipText("<html>Dubnium<br>Atomic #: 105<br>Electronegativity Value: Unknown</html>");
		btnDb.setBounds(242, 426, 58, 58);
		contentPane.add(btnDb);
		
		JButton btnSg = new JButton("Sg");
		btnSg.setToolTipText("<html>Seaborgium<br>Atomic #: 106<br>Electronegativity Value: Unknown</html>");
		btnSg.setBounds(300, 426, 58, 58);
		contentPane.add(btnSg);
		
		JButton btnBh = new JButton("Bh");
		btnBh.setToolTipText("<html>Bohrium<br>Atomic #: 107<br>Electronegativity Value: Unknown</html>");
		btnBh.setBounds(358, 426, 58, 58);
		contentPane.add(btnBh);
		
		JButton btnHs = new JButton("Hs");
		btnHs.setToolTipText("<html>Hassium<br>Atomic #: 108<br>Electronegativity Value: Unknown</html>");
		btnHs.setBounds(416, 426, 58, 58);
		contentPane.add(btnHs);
		
		JButton btnMt = new JButton("Mt");
		btnMt.setToolTipText("<html>Meitnerium<br>Atomic #: 109<br>Electronegativity Value: Unknown</html>");
		btnMt.setBounds(474, 426, 58, 58);
		contentPane.add(btnMt);
		
		JButton btnDs = new JButton("Ds");
		btnDs.setToolTipText("<html>Darmstadtium<br>Atomic #: 110<br>Electronegativity Value: Unknown</html>");
		btnDs.setBounds(532, 426, 58, 58);
		contentPane.add(btnDs);
		
		JButton btnRg = new JButton("Rg");
		btnRg.setToolTipText("<html>Roentgenium<br>Atomic #: 111<br>Electronegativity Value: Unknown</html>");
		btnRg.setBounds(590, 426, 58, 58);
		contentPane.add(btnRg);
		
		JButton btnCn = new JButton("Cn");
		btnCn.setToolTipText("<html>Copernicium<br>Atomic #: 112<br>Electronegativity Value: Unknown</html>");
		btnCn.setBounds(648, 426, 58, 58);
		contentPane.add(btnCn);
		
		JButton btnNh = new JButton("Nh");
		btnNh.setToolTipText("<html>Nihonium<br>Atomic #: 113<br>Electronegativity Value: Unknown</html>");
		btnNh.setBounds(706, 426, 58, 58);
		contentPane.add(btnNh);
		
		JButton btnFl = new JButton("Fl");
		btnFl.setToolTipText("<html>Flerovium<br>Atomic #: 114<br>Electronegativity Value: Unknown</html>");
		btnFl.setBounds(764, 426, 58, 58);
		contentPane.add(btnFl);
		
		JButton btnMc = new JButton("Mc");
		btnMc.setToolTipText("<html>Moscovium<br>Atomic #: 115<br>Electronegativity Value: Unknown</html>");
		btnMc.setBounds(822, 426, 58, 58);
		contentPane.add(btnMc);
		
		JButton btnLv = new JButton("Lv");
		btnLv.setToolTipText("<html>Livermorium<br>Atomic #: 116<br>Electronegativity Value: Unknown</html>");
		btnLv.setBounds(880, 426, 58, 58);
		contentPane.add(btnLv);
		
		JButton btnTs = new JButton("Ts");
		btnTs.setToolTipText("<html>Tennessine<br>Atomic #: 117<br>Electronegativity Value: Unknown</html>");
		btnTs.setBounds(938, 426, 58, 58);
		contentPane.add(btnTs);
		
		JButton btnOg = new JButton("Og");
		btnOg.setToolTipText("<html>Oganesson<br>Atomic #: 118<br>Electronegativity Value: N/A</html>");
		btnOg.setBounds(996, 426, 58, 58);
		contentPane.add(btnOg);
		
		JButton btnBa = new JButton("Ba");
		btnBa.setToolTipText("<html>Barium<br>Atomic #: 56<br>Electronegativity Value: 0.89</html>");
		btnBa.setBounds(68, 368, 58, 58);
		contentPane.add(btnBa);
		
		JButton btnMg = new JButton("Mg");
		btnMg.setToolTipText("<html>Magnesium<br>Atomic #: 12<br>Electronegativity Value: 1.31</html>");
		btnMg.setBounds(68, 194, 58, 58);
		contentPane.add(btnMg);
		
		JButton btnCa = new JButton("Ca");
		btnCa.setToolTipText("<html>Calcium<br>Atomic #: 20<br>Electronegativity Value: 1.00</html>");
		btnCa.setBounds(68, 252, 58, 58);
		contentPane.add(btnCa);
		
		JButton btnSr = new JButton("Sr");
		btnSr.setToolTipText("<html>Strontium<br>Atomic #: 38<br>Electronegativity Value: 0.95</html>");
		btnSr.setBounds(68, 310, 58, 58);
		contentPane.add(btnSr);
		
		JButton btnY = new JButton("Y");
		btnY.setToolTipText("<html>Yttrium<br>Atomic #: 39<br>Electronegativity Value: 1.22</html>");
		btnY.setBounds(126, 310, 58, 58);
		contentPane.add(btnY);
		
		JButton btnSc = new JButton("Sc");
		btnSc.setToolTipText("<html>Scandium<br>Atomic #: 21<br>Electronegativity Value: 1.36</html>");
		btnSc.setBounds(126, 252, 58, 58);
		contentPane.add(btnSc);
		
		JButton btnTi = new JButton("Ti");
		btnTi.setToolTipText("<html>Titanium<br>Atomic #: 22<br>Electronegativity Value: 1.54</html>");
		btnTi.setBounds(184, 252, 58, 58);
		contentPane.add(btnTi);
		
		JButton btnZr = new JButton("Zr");
		btnZr.setToolTipText("<html>Zirconium<br>Atomic #: 40<br>Electronegativity Value: 1.33</html>");
		btnZr.setBounds(184, 310, 58, 58);
		contentPane.add(btnZr);
		
		JButton btnHf = new JButton("Hf");
		btnHf.setToolTipText("<html>Hafnium<br>Atomic #: 72<br>Electronegativity Value: 1.30</html>");
		btnHf.setBounds(184, 368, 58, 58);
		contentPane.add(btnHf);
		
		JButton btnV = new JButton("V");
		btnV.setToolTipText("<html>Vanadium<br>Atomic #: 23<br>Electronegativity Value: 1.63</html>");
		btnV.setBounds(242, 252, 58, 58);
		contentPane.add(btnV);
		
		JButton btnNb = new JButton("Nb");
		btnNb.setToolTipText("<html>Niobium<br>Atomic #: 41<br>Electronegativity Value: 1.60</html>");
		btnNb.setBounds(242, 310, 58, 58);
		contentPane.add(btnNb);
		
		JButton btnCr = new JButton("Cr");
		btnCr.setToolTipText("<html>Chromium<br>Atomic #: 24<br>Electronegativity Value: 1.66</html>");
		btnCr.setBounds(300, 252, 58, 58);
		contentPane.add(btnCr);
		
		JButton btnMn = new JButton("Mn");
		btnMn.setToolTipText("<html>Manganese<br>Atomic #: 25<br>Electronegativity Value: 1.55</html>");
		btnMn.setBounds(358, 252, 58, 58);
		contentPane.add(btnMn);
		
		JButton btnFe = new JButton("Fe");
		btnFe.setToolTipText("<html>Iron<br>Atomic #: 26<br>Electronegativity Value: 1.83</html>");
		btnFe.setBounds(416, 252, 58, 58);
		contentPane.add(btnFe);
		
		JButton btnRn = new JButton("Rn");
		btnRn.setToolTipText("<html>Radon<br>Atomic #: 86<br>Electronegativity Value: N/A</html>");
		btnRn.setBounds(996, 368, 58, 58);
		contentPane.add(btnRn);
		
		JButton btnXe = new JButton("Xe");
		btnXe.setToolTipText("<html>Xenon<br>Atomic #: 54<br>Electronegativity Value: 2.60</html>");
		btnXe.setBounds(996, 310, 58, 58);
		contentPane.add(btnXe);
		
		JButton btnKr = new JButton("Kr");
		btnKr.setToolTipText("<html>Krypton<br>Atomic #: 36<br>Electronegativity Value: 3.00</html>");
		btnKr.setBounds(996, 252, 58, 58);
		contentPane.add(btnKr);
		
		JButton btnAr = new JButton("Ar");
		btnAr.setToolTipText("<html>Argon<br>Atomic #: 18<br>Electronegativity Value: N/A</html>");
		btnAr.setBounds(996, 194, 58, 58);
		contentPane.add(btnAr);
		
		JButton btnNe = new JButton("Ne");
		btnNe.setToolTipText("<html>Neon<br>Atomic #: 10<br>Electronegativity Value: N/A</html>");
		btnNe.setBounds(996, 136, 58, 58);
		contentPane.add(btnNe);
		
		JButton btnHe = new JButton("He");
		btnHe.setToolTipText("<html>Helium<br>Atomic #: 2<br>Electronegativity Value: N/A</html>");
		btnHe.setBounds(996, 78, 58, 58);
		contentPane.add(btnHe);
		
		JButton btnCo = new JButton("Co");
		btnCo.setToolTipText("<html>Cobalt<br>Atomic #: 27<br>Electronegativity Value: 1.88</html>");
		btnCo.setBounds(474, 252, 58, 58);
		contentPane.add(btnCo);
		
		JButton btnNi = new JButton("Ni");
		btnNi.setToolTipText("<html>Nickel<br>Atomic #: 28<br>Electronegativity Value: 1.91</html>");
		btnNi.setBounds(532, 252, 58, 58);
		contentPane.add(btnNi);
		
		JButton btnCu = new JButton("Cu");
		btnCu.setToolTipText("<html>Copper<br>Atomic #: 29<br>Electronegativity Value: 1.90</html>");
		btnCu.setBounds(590, 252, 58, 58);
		contentPane.add(btnCu);
		
		JButton btnZn = new JButton("Zn");
		btnZn.setToolTipText("<html>Zinc<br>Atomic #: 30<br>Electronegativity Value: 1.65</html>");
		btnZn.setBounds(648, 252, 58, 58);
		contentPane.add(btnZn);
		
		JButton btnGa = new JButton("Ga");
		btnGa.setToolTipText("<html>Gallium<br>Atomic #: 31<br>Electronegativity Value: 1.81</html>");
		btnGa.setBounds(706, 252, 58, 58);
		contentPane.add(btnGa);
		
		JButton btnGe = new JButton("Ge");
		btnGe.setToolTipText("<html>Germanium<br>Atomic #: 32<br>Electronegativity Value: 2.01</html>");
		btnGe.setBounds(764, 252, 58, 58);
		contentPane.add(btnGe);
		
		JButton btnAs = new JButton("As");
		btnAs.setToolTipText("<html>Arsenic<br>Atomic #: 33<br>Electronegativity Value: 2.81</html>");
		btnAs.setBounds(822, 252, 58, 58);
		contentPane.add(btnAs);
		
		JButton btnSe = new JButton("Se");
		btnSe.setToolTipText("<html>Selenium<br>Atomic #: 34<br>Electronegativity Value: 2.55</html>");
		btnSe.setBounds(880, 252, 58, 58);
		contentPane.add(btnSe);
		
		JButton btnBr = new JButton("Br");
		btnBr.setToolTipText("<html>Bromine<br>Atomic #: 35<br>Electronegativity Value: 2.96</html>");
		btnBr.setBounds(938, 252, 58, 58);
		contentPane.add(btnBr);
		
		JButton btnF = new JButton("F");
		btnF.setToolTipText("<html>Fluorine<br>Atomic #: 9<br>Electronegativity Value: 3.98</html>");
		btnF.setBounds(938, 136, 58, 58);
		contentPane.add(btnF);
		
		JButton btnO = new JButton("O");
		btnO.setToolTipText("<html>Oxygen<br>Atomic #: 8<br>Electronegativity Value: 3.44</html>");
		btnO.setBounds(880, 136, 58, 58);
		contentPane.add(btnO);
		
		JButton btnN = new JButton("N");
		btnN.setToolTipText("<html>Nitrogen<br>Atomic #: 7<br>Electronegativity Value: 3.04</html>");
		btnN.setBounds(822, 136, 58, 58);
		contentPane.add(btnN);
		
		JButton btnC = new JButton("C");
		btnC.setToolTipText("<html>Carbon<br>Atomic #: 6<br>Electronegativity Value: 2.55</html>");
		btnC.setBounds(764, 136, 58, 58);
		contentPane.add(btnC);
		
		JButton btnB = new JButton("B");
		btnB.setToolTipText("<html>Boron<br>Atomic #: 5<br>Electronegativity Value: 2.04</html>");
		btnB.setBounds(706, 136, 58, 58);
		contentPane.add(btnB);
		
		JButton btnAl = new JButton("Al");
		btnAl.setToolTipText("<html>Aluminum<br>Atomic #: 13<br>Electronegativity Value: 1.61</html>");
		btnAl.setBounds(706, 194, 58, 58);
		contentPane.add(btnAl);
		
		JButton btnSi = new JButton("Si");
		btnSi.setToolTipText("<html>Silicon<br>Atomic #: 14<br>Electronegativity Value: 1.90</html>");
		btnSi.setBounds(764, 194, 58, 58);
		contentPane.add(btnSi);
		
		JButton btnP = new JButton("P");
		btnP.setToolTipText("<html>Phosphorus<br>Atomic #: 15<br>Electronegativity Value: 2.19</html>");
		btnP.setBounds(822, 194, 58, 58);
		contentPane.add(btnP);
		
		JButton btnS = new JButton("S");
		btnS.setToolTipText("<html>Sulfur<br>Atomic #: 16<br>Electronegativity Value: 2.58</html>");
		btnS.setBounds(880, 194, 58, 58);
		contentPane.add(btnS);
		
		JButton btnCl = new JButton("Cl");
		btnCl.setToolTipText("<html>Chlorine<br>Atomic #: 17<br>Electronegativity Value: 3.16</html>");
		btnCl.setBounds(938, 194, 58, 58);
		contentPane.add(btnCl);
		
		JButton btnTa = new JButton("Ta");
		btnTa.setToolTipText("<html>Tantalum<br>Atomic #: 73<br>Electronegativity Value: 1.50</html>");
		btnTa.setBounds(242, 368, 58, 58);
		contentPane.add(btnTa);
		
		JButton btnW = new JButton("W");
		btnW.setToolTipText("<html>Tungsten<br>Atomic #: 74<br>Electronegativity Value: 2.36</html>");
		btnW.setBounds(300, 368, 58, 58);
		contentPane.add(btnW);
		
		JButton btnMo = new JButton("Mo");
		btnMo.setToolTipText("<html>Molybdenum<br>Atomic #: 42<br>Electronegativity Value: 2.16</html>");
		btnMo.setBounds(300, 310, 58, 58);
		contentPane.add(btnMo);
		
		JButton btnTc = new JButton("Tc");
		btnTc.setToolTipText("<html>Technetium<br>Atomic #: 43<br>Electronegativity Value: 1.90</html>");
		btnTc.setBounds(358, 310, 58, 58);
		contentPane.add(btnTc);
		
		JButton btnOs = new JButton("Os");
		btnOs.setToolTipText("<html>Osmium<br>Atomic #: 76<br>Electronegativity Value: 2.20</html>");
		btnOs.setBounds(416, 368, 58, 58);
		contentPane.add(btnOs);
		
		JButton btnIr = new JButton("Ir");
		btnIr.setToolTipText("<html>Iridium<br>Atomic #: 77<br>Electronegativity Value: 2.20</html>");
		btnIr.setBounds(474, 368, 58, 58);
		contentPane.add(btnIr);
		
		JButton btnRu = new JButton("Ru");
		btnRu.setToolTipText("<html>Ruthenium<br>Atomic #: 44<br>Electronegativity Value: 2.20</html>");
		btnRu.setBounds(416, 310, 58, 58);
		contentPane.add(btnRu);
		
		JButton btnRh = new JButton("Rh");
		btnRh.setToolTipText("<html>Rhodium<br>Atomic #: 45<br>Electronegativity Value: 2.28</html>");
		btnRh.setBounds(474, 310, 58, 58);
		contentPane.add(btnRh);
		
		JButton btnPt = new JButton("Pt");
		btnPt.setToolTipText("<html>Platinum<br>Atomic #: 78<br>Electronegativity Value: 2.28</html>");
		btnPt.setBounds(532, 368, 58, 58);
		contentPane.add(btnPt);
		
		JButton btnAu = new JButton("Au");
		btnAu.setToolTipText("<html>Gold<br>Atomic #: 79<br>Electronegativity Value: 2.54</html>");
		btnAu.setBounds(590, 368, 58, 58);
		contentPane.add(btnAu);
		
		JButton btnPd = new JButton("Pd");
		btnPd.setToolTipText("<html>Paladium<br>Atomic #: 46<br>Electronegativity Value: 2.20</html>");
		btnPd.setBounds(532, 310, 58, 58);
		contentPane.add(btnPd);
		
		JButton btnHg = new JButton("Hg");
		btnHg.setToolTipText("<html>Mercury<br>Atomic #: 80<br>Electronegativity Value: 2.00</html>");
		btnHg.setBounds(648, 368, 58, 58);
		contentPane.add(btnHg);
		
		JButton btnAg = new JButton("Ag");
		btnAg.setToolTipText("<html>Silver<br>Atomic #: 47<br>Electronegativity Value: 1.93</html>");
		btnAg.setBounds(590, 310, 58, 58);
		contentPane.add(btnAg);
		
		JButton btnCd = new JButton("Cd");
		btnCd.setToolTipText("<html>Cadmium<br>Atomic #: 48<br>Electronegativity Value: 1.69</html>");
		btnCd.setBounds(648, 310, 58, 58);
		contentPane.add(btnCd);
		
		JButton btnTl = new JButton("Tl");
		btnTl.setToolTipText("<html>Thallium<br>Atomic #: 81<br>Electronegativity Value: 1.62</html>");
		btnTl.setBounds(706, 368, 58, 58);
		contentPane.add(btnTl);
		
		JButton btnIn = new JButton("In");
		btnIn.setToolTipText("<html>Indium<br>Atomic #: 49<br>Electronegativity Value: 1.78</html>");
		btnIn.setBounds(706, 310, 58, 58);
		contentPane.add(btnIn);
		
		JButton btnPb = new JButton("Pb");
		btnPb.setToolTipText("<html>Lead<br>Atomic #: 82<br>Electronegativity Value: 2.33</html>");
		btnPb.setBounds(764, 368, 58, 58);
		contentPane.add(btnPb);
		
		JButton btnBi = new JButton("Bi");
		btnBi.setToolTipText("<html>Bismuth<br>Atomic #: 83<br>Electronegativity Value: 2.02</html>");
		btnBi.setBounds(822, 368, 58, 58);
		contentPane.add(btnBi);
		
		JButton btnSn = new JButton("Sn");
		btnSn.setToolTipText("<html>Tin<br>Atomic #: 50<br>Electronegativity Value: 1.96</html>");
		btnSn.setBounds(764, 310, 58, 58);
		contentPane.add(btnSn);
		
		JButton btnPo = new JButton("Po");
		btnPo.setToolTipText("<html>Polonium<br>Atomic #: 84<br>Electronegativity Value: 2.00</html>");
		btnPo.setBounds(880, 368, 58, 58);
		contentPane.add(btnPo);
		
		JButton btnSb = new JButton("Sb");
		btnSb.setToolTipText("<html>Antimony<br>Atomic #: 51<br>Electronegativity Value: 2.05</html>");
		btnSb.setBounds(822, 310, 58, 58);
		contentPane.add(btnSb);
		
		JButton btnAt = new JButton("At");
		btnAt.setToolTipText("<html>Astatine<br>Atomic #: 85<br>Electronegativity Value: 2.20</html>");
		btnAt.setBounds(938, 368, 58, 58);
		contentPane.add(btnAt);
		
		JButton btnTe = new JButton("Te");
		btnTe.setToolTipText("<html>Telerium<br>Atomic #: 52<br>Electronegativity Value: 2.10</html>");
		btnTe.setBounds(880, 310, 58, 58);
		contentPane.add(btnTe);
		
		JButton btnI = new JButton("I");
		btnI.setToolTipText("<html>Iodine<br>Atomic #: 53<br>Electronegativity Value: 2.66</html>");
		btnI.setBounds(938, 310, 58, 58);
		contentPane.add(btnI);
		
		JButton btnRe = new JButton("Re");
		btnRe.setToolTipText("<html>Rhenium<br>Atomic #: 75<br>Electronegativity Value: 1.9</html>");
		...
		btnLa.setToolTipText("<html>Lanthinum<br>Atomic #: 57<br>Electronegativity Value: 1.10</html>");
		btnLa.setBounds(184, 510, 58, 58);
		contentPane.add(btnLa);
		
		JButton btnAc = new JButton("Ac");
		btnAc.setToolTipText("<html>Actinium<br>Atomic #: 89<br>Electronegativity Value: 1.10</html>");
		btnAc.setBounds(184, 568, 58, 58);
		contentPane.add(btnAc);
		
		JButton btnCe = new JButton("Ce");
		btnCe.setToolTipText("<html>Cerium<br>Atomic #: 58<br>Electronegativity Value: 1.12</html>");
		btnCe.setBounds(242, 510, 58, 58);
		contentPane.add(btnCe);
		
		JButton btnTh = new JButton("Th");
		btnTh.setToolTipText("<html>Thorium<br>Atomic #: 90<br>Electronegativity Value: 1.30</html>");
		btnTh.setBounds(242, 568, 58, 58);
		contentPane.add(btnTh);
		
		JButton btnPr = new JButton("Pr");
		btnPr.setToolTipText("<html>Praseodymium<br>Atomic #: 59<br>Electronegativity Value: 1.13</html>");
		btnPr.setBounds(300, 510, 58, 58);
		contentPane.add(btnPr);
		
		JButton btnPa = new JButton("Pa");
		btnPa.setToolTipText("<html>Protactinium<br>Atomic #: 91<br>Electronegativity Value: 1.50</html>");
		btnPa.setBounds(300, 568, 58, 58);
		contentPane.add(btnPa);
		
		JButton btnNd = new JButton("Nd");
		btnNd.setToolTipText("<html>Neodymium<br>Atomic #: 60<br>Electronegativity Value: 1.14</html>");
		btnNd.setBounds(358, 510, 58, 58);
		contentPane.add(btnNd);
		
		JButton btnU = new JButton("U");
		btnU.setToolTipText("<html>Uranium<br>Atomic #: 92<br>Electronegativity Value: 1.38</html>");
		btnU.setBounds(358, 568, 58, 58);
		contentPane.add(btnU);
		
		JButton btnPm = new JButton("Pm");
		btnPm.setToolTipText("<html>Promethium<br>Atomic #: 61<br>Electronegativity Value: 1.13</html>");
		btnPm.setBounds(416, 510, 58, 58);
		contentPane.add(btnPm);
		
		JButton btnNp = new JButton("Np");
		btnNp.setToolTipText("<html>Neptunium<br>Atomic #: 93<br>Electronegativity Value: 1.36</html>");
		btnNp.setBounds(416, 568, 58, 58);
		contentPane.add(btnNp);
		
		JButton btnSm = new JButton("Sm");
		btnSm.setToolTipText("<html>Samarium<br>Atomic #: 62<br>Electronegativity Value: 1.17</html>");
		btnSm.setBounds(474, 510, 58, 58);
		contentPane.add(btnSm);
		
		JButton btnPu = new JButton("Pu");
		btnPu.setToolTipText("<html>Plutonium<br>Atomic #: 94<br>Electronegativity Value: 1.28</html>");
		btnPu.setBounds(474, 568, 58, 58);
		contentPane.add(btnPu);
		
		JButton btnEu = new JButton("Eu");
		btnEu.setToolTipText("<html>Europium<br>Atomic #: 63<br>Electronegativity Value: 1.20</html>");
		btnEu.setBounds(532, 510, 58, 58);
		contentPane.add(btnEu);
		
		JButton btnAm = new JButton("Am");
		btnAm.setToolTipText("<html>Americium<br>Atomic #: 95<br>Electronegativity Value: 1.30</html>");
		btnAm.setBounds(532, 568, 58, 58);
		contentPane.add(btnAm);
		
		JButton btnGd = new JButton("Gd");
		btnGd.setToolTipText("<html>Gadolinium<br>Atomic #: 64<br>Electronegativity Value: 1.20</html>");
		btnGd.setBounds(590, 510, 58, 58);
		contentPane.add(btnGd);
		
		JButton btnTb = new JButton("Tb");
		btnTb.setToolTipText("<html>Terbium<br>Atomic #: 65<br>Electronegativity Value: 1.22</html>");
		btnTb.setBounds(648, 510, 58, 58);
		contentPane.add(btnTb);
		
		JButton btnDy = new JButton("Dy");
		btnDy.setToolTipText("<html>Dysprosium<br>Atomic #: 66<br>Electronegativity Value: 1.23</html>");
		btnDy.setBounds(706, 510, 58, 58);
		contentPane.add(btnDy);
		
		JButton btnHo = new JButton("Ho");
		btnHo.setToolTipText("<html>Holmium<br>Atomic #: 67<br>Electronegativity Value: 1.24</html>");
		btnHo.setBounds(764, 510, 58, 58);
		contentPane.add(btnHo);
		
		JButton btnEb = new JButton("Er");
		btnEb.setToolTipText("<html>Erbium<br>Atomic #: 68<br>Electronegativity Value: 1.24</html>");
		btnEb.setBounds(822, 510, 58, 58);
		contentPane.add(btnEb);
		
		JButton btnTm = new JButton("Tm");
		btnTm.setToolTipText("<html>Thulium<br>Atomic #: 69<br>Electronegativity Value: 1.25</html>");
		btnTm.setBounds(880, 510, 58, 58);
		contentPane.add(btnTm);
		
		JButton btnYb = new JButton("Yb");
		btnYb.setToolTipText("<html>Ytterbium<br>Atomic #: 71<br>Electronegativity Value: 1.10</html>");
		btnYb.setBounds(938, 510, 58, 58);
		contentPane.add(btnYb);
		
		JButton btnLu = new JButton("Lu");
		btnLu.setToolTipText("<html>Lutetium<br>Atomic #: 71<br>Electronegativity Value: 1.27</html>");
		btnLu.setBounds(996, 510, 58, 58);
		contentPane.add(btnLu);
		
		JButton btnCm = new JButton("Cm");
		btnCm.setToolTipText("<html>Curium<br>Atomic #: 96<br>Electronegativity Value: 1.30</html>");
		btnCm.setBounds(590, 568, 58, 58);
		contentPane.add(btnCm);
		
		JButton btnBk = new JButton("Bk");
		btnBk.setToolTipText("<html>Berkelium<br>Atomic #: 97<br>Electronegativity Value: 1.30</html>");
		btnBk.setBounds(648, 568, 58, 58);
		contentPane.add(btnBk);
		
		JButton btnCf = new JButton("Cf");
		btnCf.setToolTipText("<html>Califormium<br>Atomic #: 98<br>Electronegativity Value: 1.30</html>");
		btnCf.setBounds(706, 568, 58, 58);
		contentPane.add(btnCf);
		
		JButton btnEs = new JButton("Es");
		btnEs.setToolTipText("<html>Einsteinium<br>Atomic #: 99<br>Electronegativity Value: 1.30</html>");
		btnEs.setBounds(764, 568, 58, 58);
		contentPane.add(btnEs);
		
		JButton btnFm = new JButton("Fm");
		btnFm.setToolTipText("<html>Fermium<br>Atomic #: 100<br>Electronegativity Value: 1.30</html>");
		btnFm.setBounds(822, 568, 58, 58);
		contentPane.add(btnFm);
		
		JButton btnMd = new JButton("Md");
		btnMd.setToolTipText("<html>Mendelvium<br>Atomic #: 101<br>Electronegativity Value: 1.30</html>");
		btnMd.setBounds(880, 568, 58, 58);
		contentPane.add(btnMd);
		
		JButton btnNo = new JButton("No");
		btnNo.setToolTipText("<html>Nobelium<br>Atomic #: 102<br>Electronegativity Value: 1.30</html>");
		btnNo.setBounds(938, 568, 58, 58);
		contentPane.add(btnNo);
		
		JButton btnLr = new JButton("Lr");
		btnLr.setToolTipText("<html>Lawrencium<br>Atomic #: 103<br>Electronegativity Value: Unknown</html>");
				...
				if (e[0] != 2){
					...
					if ((ArrayUtils.contains(cations, be[0]) && ArrayUtils.contains(anions, be[1])) || (ArrayUtils.contains(anions, be[0]) && ArrayUtils.contains(cations, be[1]))){
						...
						if (eneg1 == 0.00 || eneg2 == 0.00){
							...
							if (eneg1 > eneg2){
								e_diff.setText(Double.toString(eneg1 - eneg2));
							}
							else if (eneg2 > eneg1){
								e_diff.setText(Double.toString(eneg2 - eneg1));
							}
						}
					}
				}
